...
class TestExpandingBloomFilter(unittest.TestCase):
    ...
    def test_ebf_check(self):
        ...
        self.assertEqual(blm.check("this is yet another test"), True)   # this is false positive
    ...
    def test_ebf_contains(self):
        ...
        self.assertEqual("this is yet another test" in blm, True)   # this is false positive
